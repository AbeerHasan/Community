...
//  Community
//
//  Created by Mohammed Mohsin Sayed on 12/24/19.
...
class AppDelegate: UIResponder, UIApplicationDelegate{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
       ...
       GIDSignIn.sharedInstance().clientID = FirebaseApp.app()!.options.clientID
        ...
        //Present the login page if the user not loging in
        if Auth.auth().currentUser == nil {
            ...
            window?.rootViewController?.present(authVC, animated: true, completion: nil) //showing the normal starting page under the authVC
        }
        return true
    }
